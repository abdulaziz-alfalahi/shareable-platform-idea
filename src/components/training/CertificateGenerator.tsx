    ...
    <Card className="w-full">
      ...
      <CardContent>
        <div className="flex flex-col items-center">
          <div 
            ref={certificateRef}
            className="w-full max-w-2xl border-8 border-double border-emirati-desertGold/30 p-8 mb-6 bg-white"
          >
            {/* Certificate Header */}
            ...
            {/* Certificate Footer */}
            <div className="flex justify-between items-end pt-6 mt-8 border-t border-emirati-desertGold/30">
              <div>
