  ...
  const getFilteredLocationJobs = () => {
    switch (activeLocationFilter) {
      ...
      case 'portfolio-match':
        return sampleJobs.filter(job => job.portfolioMatch === true);
      case 'all':
      default:
        return sampleJobs;
    }
    ...
    <div className="container mx-auto py-10 px-4">
      ...
      <Tabs defaultValue="applications" className="w-full">
        ...
        <TabsContent value="location">
          ...
          <div className="mb-6">
            <Tabs defaultValue="all" onValueChange={(value) => setActiveLocationFilter(value as 'ai-top-10' | 'portfolio-match' | 'all')} className="w-full">
